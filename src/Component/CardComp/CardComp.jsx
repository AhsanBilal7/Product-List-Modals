...
function ProfileCard() {
  ...
  useEffect(() => {
    if (arrayName == "Chairs") {
      setShowArray(chairs);
    } else if (arrayName == "Tables") {
      setShowArray(tables);
    } else if (arrayName == "Shoes") {
      setShowArray(shoes);
    }
  }, [arrayName]);
      ...
      <div className="container">
        <div className="card">
          ...
          <div className="buttons">
            <button className={isActive ? "" : "btnActive"} onClick={addClass}>
          ...
          <div className="last_buttons">
            <div className="qty_btn">
              <i onClick={DecBag} className="fa fa-minus">
                <b>-</b>
              </i>
              <p>{addbag}</p>
              <i onClick={AddBag} className="fa fa-plus">
                <b>+</b>
              </i>
            </div>
